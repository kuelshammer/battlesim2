...
fn test_intensity_regression_high_penalty() {
        ...
        rounds: vec![Round {
            team1: vec![
                Combattant {
                    id: "f1".to_string(),
                    team: 0,
                    creature: std::sync::Arc::new(fighter.clone()),
                    initiative: 10.0,
    ...
    assert_ne!(
        ...
        simulation_wasm::decile_analysis::IntensityTier::Tier1,
        "Intensity should NOT be Tier 1"
    );
}
...
fn test_resource_timeline_points() {
    ...
    assert_eq!(
        timeline.len(),
        4,
        "Timeline should have 4 points for a 3-encounter day"
    );
