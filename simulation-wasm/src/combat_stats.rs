...
impl CombatStatsCache {
    ...
    pub fn get_stats(&mut self, combatant: &Combattant) -> &CombatantStats {
        ...
        self.stats_cache
            ...
            .or_insert_with(|| CombatantStats::calculate(&combatant.creature))
    }
...
mod tests {
    use super::*;
    use crate::model::{Action, ActionCondition, AtkAction, DiceFormula, Frequency};
