...
- [x] Task: Update `FuelGauge.tsx` props and rendering logic to support structured segments, rest dividers, and labels. (0c2e390)
- [x] Task: Update `fuelGauge.module.scss` with styles for alternating colors, labels, and green rest dividers. (0c2e390)
- [ ] Task: Visual Verification - Ensure labels and alternating colors are clear even with high encounter counts.
- [ ] Task: Conductor - User Manual Verification 'Phase 2' (Protocol in workflow.md)

## Phase 3: Dashboard Integration & Polish [checkpoint: final]
Goal: Finalize integration and ensure responsiveness for various adventuring day sizes.

- [x] Task: Verify the "Descent Graph" and "Assistant Summary" remain consistent with the new budget scaling. (final)
- [x] Task: Performance Check - Ensure the dashboard remains snappy with 10+ timeline items. (final)
- [x] Task: Conductor - User Manual Verification 'Phase 3' (final)

---
**Track Completed.**
Implemented dual-gauge visualization and addressed feedback regarding label centering and rest clarity.
